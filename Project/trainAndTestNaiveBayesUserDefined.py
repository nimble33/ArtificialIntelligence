            ...
            if len(line)==1:
                ...
                if(choice==1):
                    ...
                    if (positiveScore > negativeScore):
                        testResults1.append('positive')
                    else:
                        testResults1.append('negative')
                if(choice==2):
                    ...
                    if (maxValue == score1):
                        testResults2.append('1')
                    elif (maxValue == score2):
                        testResults2.append('2')
                    elif (maxValue == score3):
                        testResults2.append('3')
                    elif (maxValue == score4):
                        testResults2.append('4')
                    else:
                        testResults2.append('5')
    if(choice==1):
        return testResults1
    if(choice==2):
        return testResults2
...
#Used by test suite - for PosNeg Prediction
def testPosNeg():
    TRAIN_SET_POSNEG = 'train/trainActual.csv'
    TEST_SET = 'test/testSample.csv'
    targetLabelCount, wordLabelCount = divideTraining(TRAIN_SET_POSNEG,1)
    predictedResultList = naiveBayesClassifyAndTest(1, targetLabelCount, wordLabelCount, TEST_SET)
    return predictedResultList
#Used by test suite - for Stars Prediction
def testStars():
    TRAIN_SET_STARS = 'train/trainActualStars.csv'
    TEST_SET = 'test/testSample.csv'
    targetLabelCount, wordLabelCount = divideTraining(TRAIN_SET_STARS,2)
   # print wordLabelCount
    predictedResultList = naiveBayesClassifyAndTest(2, targetLabelCount, wordLabelCount, TEST_SET)
    return predictedResultList
...
class TestPredictions(unittest.TestCase):
    ...
    def testStars(self):
        predList = testStars()
        actualList = ['4']
        self.assertEqual(predList, actualList)
